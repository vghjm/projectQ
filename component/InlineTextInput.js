    ...
    <View style={props.style}>
      <TouchableWithoutFeedback onPress={onPress}>
        <View style={{marginHorizontal: 20, height: 70, borderWidth: 4, borderColor: isFocus?color.focus : color.default, flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start'}}>
          ...
          <TextInput ref={ref => textInputRef = ref} placeholder={placeholder}  maxLength={40} secureTextEntry={textType==='password'?true:false} textContentType={'oneTimeCode'} style={{position:'absolute', bottom:5, left:10, right:5, borderWidth:0, fontSize:18}} value={text} onChangeText={props.onChangeText}/>
        </View>
