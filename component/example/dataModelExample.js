...
export const subscribeDataType = [
  ...
  {p_id: 9, s_id: 9, pushStartTime: Moment('20201025 0830'), pushEndTime: Moment('20201025 0830')},
];
export const chatroomDataType = [
  ...
  {
    p_id: 9, getPushAlarm: true, lastCheckedTime: Moment('20200712 0858'), newItemCount: 0,
    lastPushed: {pushTime: Moment(), q_id: 1, solved:true},
    chatMessageList: [
      { _id: 10, text: '좋은데~? 잘 할 수 있을거야! 빠샤~!', createdAt: Moment('20200712 0856'),
        user: { _id:2, avatar: require('../../assets/product/newQ하이라이트/thumbnail.png')},
      },
      {
        _id: 9, text: '오! 오늘 중학교 친구에게 연락이나 한번 해봐야겠다. 오랜만에 전화하면 진짜 반가울 거 같아ㅋㅋㅋ', createdAt: Moment('20200712 0853'),
        user: { _id:1,},
      },
      { _id: 8, text: '오늘 소소하게 하고 싶은 일이 뭐야? 난 연락을 못했던 친구에게 안부를 물어봐야겠다. 너는?', createdAt: Moment('20200712 0830'),
        user: { _id:2, avatar: require('../../assets/product/newQ하이라이트/thumbnail.png')},
      },
      { _id: 7, text: '그래~~멋지다😍😍 매일 행동하는 너가 대단해..!!', createdAt: Moment('20200711 0841'),
        user: { _id:2, avatar: require('../../assets/product/newQ하이라이트/thumbnail.png')},
      },
      {
        _id: 6, text: '오늘은 저녁에 10분 정도 운동을 해야겠어. 틈날 때마다 조금씩이라도 운동을 해보려고!', createdAt: Moment('20200711 0838'),
        user: { _id:1,},
      },
      { _id: 5, text: '오늘 소소하게 하고 싶은 일이 뭐야?', createdAt: Moment('20200711 0831'),
        user: { _id:2, avatar: require('../../assets/product/newQ하이라이트/thumbnail.png')},
      },
      ...
      {
        _id: 3, text: '오늘은 꼭 밀렸던 집안일을 해치우겠어!!! 빨래도 하고 방도 쓸거야~~', createdAt: Moment('20200710 0835'),
        user: { _id:1,},
      },
      ...
      {
        _id: 1, text: '이제 Q 하이라이 구독이 시작됩니다.\n오전 8시 30분이 되면 질문 드릴게요.', createdAt: Moment('20200709 171321'),
        user: { _id:2, avatar: require('../../assets/product/newQ하이라이트/thumbnail.png')},
      },
    ]
  },
...
export const diaryDataType = [
  ...
  // },
  {
    p_id: 8, d_id: 8, title: 'THANK Q 노트', color: 2, pos: 1, makeTime: Moment('20200704 0813'), totalUpdateCount: 3,
    diarymessageList: [
  ...
  {
    p_id: 9, d_id: 8, title: 'Q 하이라이트', color: 3, pos: 2, makeTime: Moment('20200709 171321'), totalUpdateCount: 3,
    diarymessageList: [
      { _id: 1, text: '', createdAt: Moment('20200710 0835'), islagacy: false, linkedMessageList: [{text: '오늘은 꼭 밀렸던 집안일을 해치우겠어!!! 빨래도 하고 방도 쓸거야~~', id:3}]},
      { _id: 2, text: '', createdAt: Moment('20200711 0838'), islagacy: false, linkedMessageList: [{text: '오늘은 저녁에 10분 정도 운동을 해야겠어. 틈날 때마다 조금씩이라도 운동을 해보려고!', id:6}]},
      { _id: 3, text: '', createdAt: Moment('20200712 0853'), islagacy: false, linkedMessageList: [{text: '오! 오늘 중학교 친구에게 연락이나 한번 해봐야겠다. 오랜만에 전화하면 진짜 반가울 거 같아ㅋㅋㅋ', id:9}]},
    ]
  },
];
